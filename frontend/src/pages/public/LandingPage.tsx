...
const PHOTOS = [
  { url: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600&h=600&fit=crop', alt: 'Coffee being poured' },
  { url: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=600&h=600&fit=crop', alt: 'Latte art' },
  { url: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=600&h=600&fit=crop', alt: 'Barista making coffee' },
  { url: 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=600&h=600&fit=crop', alt: 'Coffee beans close up' },
  { url: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=600&h=600&fit=crop', alt: 'Coffee shop vibes' },
  { url: 'https://images.unsplash.com/photo-1511920170033-f8396924c348?w=600&h=600&fit=crop', alt: 'Iced coffee drink' },
];
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden lg:block">
              <div className="relative">
                <img src={PHOTOS[0].url} alt="Coffee" className="rounded-3xl shadow-2xl w-full max-w-md ml-auto object-cover aspect-[4/5]" />
                <img src={PHOTOS[1].url} alt="Latte art" className="absolute -bottom-8 -left-8 w-48 h-48 rounded-2xl shadow-xl object-cover border-4 border-white" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="grid grid-cols-2 gap-4">
              <img src={PHOTOS[2].url} alt="Barista" className="rounded-2xl shadow-lg object-cover aspect-[3/4] w-full" />
              <img src={PHOTOS[4].url} alt="Coffee shop" className="rounded-2xl shadow-lg object-cover aspect-[3/4] w-full mt-8" />
            </div>
            <div>
      ...
      <section className="py-16" style={{ backgroundColor: '#F5F0E8' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="text-2xl font-bold mb-2" style={{ color: '#4A3428' }}>Follow the Vibes</h3>
          <div className="flex items-center justify-center gap-6 mb-6">
            <a href="https://www.instagram.com/sixbeanscoffee/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm font-medium hover:underline" style={{ color: '#5CB832' }}>
            ...
            <a href="https://www.facebook.com/sixbeanscoffee/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm font-medium hover:underline" style={{ color: '#5CB832' }}>
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              Six Beans Coffee Co.
            </a>
            <a href="https://www.tiktok.com/@six.beans.coffee" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm font-medium hover:underline" style={{ color: '#5CB832' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <div className="mt-8">
                <img src={PHOTOS[2].url} alt="Barista team" className="rounded-2xl shadow-xl w-full max-w-sm object-cover aspect-video" />
              </div>
